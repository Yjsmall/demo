...
if exist "%CONTEXT_READER_MSYS2_ROOT%\ucrt64\bin\clang++.exe" goto activate
...
echo MSYS2 UCRT64 with Clang or GCC was not found. Set CONTEXT_READER_MSYS2_ROOT to the standalone MSYS2 root. 1>&2
exit /b 1
